...
class MyHarness(Harness):
    def __init__(self, call_llm, count_tokens, count_messages_tokens, max_prompt_tokens: int,tokenize_fn_name:str='default',sim_fn_name:str='jaccard',top_k:int=35):
    ...
    def build_top_k(self):
        # 在所给的text classification task中， top_k=30比较好， 大概ratio是 30/77 = 0.38961 
        ratio = 0.39
        total_labels = len(self.label_order)
        top_k = round(total_labels * ratio)
        return top_k
